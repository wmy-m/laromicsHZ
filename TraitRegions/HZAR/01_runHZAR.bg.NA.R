...
save(fit_modelSelected, file = paste0("./NA.bg/NA.HZAR_v2_bgHI_task", task_id, ".RData"))
write.table(recheck_modelfit, 
            file = paste0("./NA.bg/NA.HZAR_v2_bgHI_convergence_failed.bestmodel_task", task_id, ".txt"),
